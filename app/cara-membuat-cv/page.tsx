...
export const metadata = {
  title: 'Cara Membuat CV Profesional - ResumeKu',
  description: 'Panduan lengkap cara membuat CV profesional dengan AI. Ikuti 4 langkah mudah untuk CV yang menarik perhatian HRD.',
  keywords: 'cara membuat cv, panduan cv, cv profesional, membuat cv dengan ai',
  openGraph: {
    title: 'Cara Membuat CV Profesional - ResumeKu',
    description: 'Panduan lengkap cara membuat CV profesional dengan AI. Ikuti 4 langkah mudah untuk CV yang menarik perhatian HRD.',
    url: 'https://resumeku.vercel.app/cara-membuat-cv',
    siteName: 'ResumeKu',
    locale: 'id_ID',
    type: 'article',
  },
  twitter: {
    ...
    title: 'Cara Membuat CV Profesional - ResumeKu',
    description: 'Panduan lengkap cara membuat CV profesional dengan AI',
  },
}

export default function CaraMembuatCVPage() {
  const steps = [
    {
      number: 1,
